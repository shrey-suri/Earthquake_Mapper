...
public class EarthquakeCityMap extends PApplet {
	...
	*/
	...
	{	
		...
		fill(255,255,255);
		rect(1000,50,190,200);
		textSize(20);
		fill(black);
		text("Earthquake Key", 1025,77);
		textSize(15);
		fill(red);
		ellipse(1030,115,14,14);
		fill(black);
		text("5.0+ Magnitude", 1055,120);
		fill(yellow);
		ellipse(1030,165,10,10);
		fill(black);
		text("4.0+ Magnitude", 1055,170);
		fill(blue);
		ellipse(1030,210,7,7);
		fill(black);
		text("Below 4.0", 1055,215);
